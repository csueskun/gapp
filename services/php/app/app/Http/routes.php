...
Route::get('/soap/number-to-words/{number}', 'ProductoPedidoIngredienteController@getConversionRate');
...
Route::post('/caja/resumen-ventas', 'DocumentoController@resumenVentas');
...
Route::get('/test-printer/{printer}/{width}', 'ConfigController@prepararImpresoraPos');
// Route::get('/test-printers', 'ConfigController@prepararImpresoraPos');
