        ...
        <table id="example" class="display datatable" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $adicional->producto->descripcion }}</td>
                    <td>{{ $adicional->tipo_producto->descripcion }}</td>
                    <td>{{ $adicional->ingrediente->descripcion }}</td>
                    <td class="min-width text-align-center">
                    <a href="editar/{{ $adicional->id }}"><span class="glyphicon glyphicon-pencil"></span></a>
