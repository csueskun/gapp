...
<section class="borde-inferior lista fondo-comun"  style="min-height: 80vh;">
    <div class="container">
        ...
        <h1 class="titulo">Producto Ingrediente</h1>
        ...
        <table id="example" class="display datatable" cellspacing="0" width="100%">
            ...
            <tbody>
                @foreach($producto_ingrediente_lista as $producto_ingrediente)
                <tr>
                    <td>{{ $producto_ingrediente->producto->descripcion }}</td>
                    <td>{{ $producto_ingrediente->ingrediente->descripcion }}</td>
                    <td class="min-width text-align-center">
                    <a href="editar/{{ $producto_ingrediente->id }}"><span class="glyphicon glyphicon-pencil"></span></a>
