...
<section class="borde-inferior lista fondo-comun"  style="min-height: 80vh;">
    <div class="container">
        ...
        <h1 class="titulo">Producto Sabor</h1>
        ...
        <table id="example" class="display datatable" cellspacing="0" width="100%">
            ...
            <tbody>
                @foreach($producto_sabor_lista as $producto_sabor)
                <tr>
                    <td>{{ $producto_sabor->producto->descripcion }}</td>
                    <td>{{ $producto_sabor->sabor->descripcion }}</td>
                    <td class="min-width text-align-center">
                    <a href="editar/{{ $producto_sabor->id }}"><span class="glyphicon glyphicon-pencil"></span></a>
