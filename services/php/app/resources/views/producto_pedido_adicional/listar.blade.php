...
<section class="borde-inferior lista fondo-comun"  style="min-height: 80vh;">
    <div class="container">
        ...
        <h1 class="titulo">Producto Pedido Adicional</h1>
        ...
        <table id="example" class="display datatable" cellspacing="0" width="100%">
            ...
            <tbody>
                @foreach($producto_pedido_adicional_lista as $producto_pedido_adicional)
                <tr>
                    <td>{{ $producto_pedido_adicional->producto_pedido->descripcion }}</td>
                    <td>{{ $producto_pedido_adicional->adicional->descripcion }}</td>
                    <td>{{ $producto_pedido_adicional->cant }}</td>
                    <td>{{ $producto_pedido_adicional->valor }}</td>
                    <td>{{ $producto_pedido_adicional->total }}</td>
                    <td class="min-width text-align-center">
                    <a href="editar/{{ $producto_pedido_adicional->id }}"><span class="glyphicon glyphicon-pencil"></span></a>
