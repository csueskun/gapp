...
<section class="borde-inferior lista fondo-comun"  style="min-height: 80vh;">
    <div class="container">
        ...
        <h1 class="titulo">Producto Pedido Documento</h1>
        ...
        <table id="example" class="display datatable" cellspacing="0" width="100%">
            ...
            <tbody>
                @foreach($producto_pedido_documento_lista as $producto_pedido_documento)
                <tr>
                    <td>{{ $producto_pedido_documento->producto_id }}</td>
                    <td>{{ $producto_pedido_documento->cant }}</td>
                    <td>{{ $producto_pedido_documento->valor }}</td>
                    <td>{{ $producto_pedido_documento->total }}</td>
                    <td>{{ $producto_pedido_documento->producto_pedido_id }}</td>
                    <td class="min-width text-align-center">
                    <a href="editar/{{ $producto_pedido_documento->id }}"><span class="glyphicon glyphicon-pencil"></span></a>
