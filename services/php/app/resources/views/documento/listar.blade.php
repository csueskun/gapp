        ...
        <div class="dataTables_wrapper form-inline dt-bootstrap no-footer">
            <div class="col-md-4">
                <div class="dataTables_length" id="example_length">
                    <label>Mostrar 
                        <select id="por_pagina" name="example_length" aria-controls="example" class="form-control input-sm">
                            <option>100</option>
                            <option>50</option>
                            <option>20</option>
            ...
            <br/>
            <br/>
            <table class="table table-striped table-bordered datatable" cellspacing="0" width="100%" style="margin-left: 10px; margin-right: 10px; background-color: white">
                <thead>
                    <tr>
