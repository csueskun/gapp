...
<script>
    ...
    function calcularTiempo(){
        $('.fecha_toma_pedido').each(function () {
            var pedidoFecha = moment($(this).attr('fecha')).tz("America/Bogota", true);
            var now = moment(new Date());
            var dur = moment.duration(now.diff(pedidoFecha));
            var totalMinutes = Math.floor(dur.asMinutes());
