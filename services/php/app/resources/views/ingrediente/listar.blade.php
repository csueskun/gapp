        ...
        <table class="midatatable" cellspacing="0" id='tabla_ingredientes'>
            ...
            <tbody>
                ...
                <tr id="{{ $ingrediente->id }}">
                    ...
                    <td width="1" class="centrado">
                        <a href="#" data-trigger="hover" data-html="true" data-toggle="popover"
                            data-content="<img src='/images/ingrediente/{{ $ingrediente->imagen }}' style='height: 100px'/>">
                            <img src='/images/ingrediente/{{ $ingrediente->imagen }}' style='height: 30px'/>
                        </a>
                    </td>
                    ...
                    <td class="centrado" width="1">
                        @if ($ingrediente->visible == '1')
...
<script>
    $(function() {
        ...
        var table = $('#tabla_ingredientes').DataTable({
            "pageLength": 16,
            "lengthMenu": [[16, 32, -1], [16, 32, "Todos"]]
        });
        ...
        $('#tabla_ingredientes').on('draw.dt', function () {
            $('[data-toggle="popover"]').popover({
                trigger: 'hover',
                html: true
            });
