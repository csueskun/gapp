...
<section class="borde-inferior lista fondo-comun"  style="min-height: 80vh;">
    <div class="container">
        ...
        <br/>
        <table id="terceros-tabla" class="table table-striped table-bordered datatable" cellspacing="0" width="100%">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr id='{{ $tercero->id }}'>
                    ...
                    <td class="min-width text-align-center fix-datatable">
...
<script>
    ...
    $(function() {
        $('#terceros-tabla').DataTable({
            "lengthMenu": [[30, 50, 100, 150, -1], [30, 50, 100, 150, "Todo"]]
        });
