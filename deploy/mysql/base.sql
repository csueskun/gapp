...
--
-- Estructura de tabla para la tabla `pizza_adicional`
--
...
--
-- Estructura de tabla para la tabla `pizza_combo`
--
...
--
-- Estructura de tabla para la tabla `pizza_combo_producto`
--

CREATE TABLE `pizza_combo_producto` (
  `id` int(10) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pizza_config`
--

CREATE TABLE `pizza_config` (
  `id` int(10) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pizza_detalle_documento`
--

CREATE TABLE `pizza_detalle_documento` (
...
--
-- Estructura de tabla para la tabla `pizza_documento`
--

CREATE TABLE `pizza_documento` (
  `id` int(10) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pizza_documento_formapago`
--

CREATE TABLE `pizza_documento_formapago` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pizza_formapago`
--

CREATE TABLE `pizza_formapago` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `pizza_ingrediente` (
  ...
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `imagen` varchar(45) DEFAULT 'ingrediente.png',
...
INSERT INTO `pizza_ingrediente` (`id`, `codigo`, `descripcion`, `unidad`, `created_at`, `updated_at`, `imagen`, `visible`, `grupo`) VALUES
...
(127, NULL, 'PEPERONI', 'und', '2019-06-22 18:21:09', '2025-01-27 17:26:29', 'ingrediente.png', 0, ''),
...
(149, NULL, 'postre', 'und', '2019-07-26 22:44:20', '2019-07-26 22:44:20', 'ingrediente.png', 1, ''),
...
(162, NULL, 'PEPITAS DULCES', 'gr', '2019-11-19 18:27:21', '2019-11-19 18:27:21', 'ingrediente.png', 1, NULL),
...
(168, NULL, 'MANI TRITURADO', 'gr', '2019-11-19 18:28:15', '2019-11-19 18:30:15', 'ingrediente.png', 1, '2 RELLENO'),
(169, NULL, 'GALLETA OREO', 'gr', '2019-11-19 18:28:23', '2019-11-19 18:29:49', 'ingrediente.png', 1, 'TOPPINGS'),
...
(180, NULL, 'PRINCIPIO', 'gr', '2020-02-15 18:48:51', '2020-02-15 18:48:51', 'ingrediente.png', 1, NULL),
...
(197, NULL, 'Socle', 'kg', '2021-03-07 03:04:30', '2021-03-07 03:04:30', 'ingrediente.png', 1, NULL),
(199, NULL, 'CON AGUA', 'gr', '2021-03-18 06:12:24', '2021-03-18 06:18:39', 'ingrediente.png', 1, '1 COMBO'),
(200, NULL, 'CON GASEOSA', 'gr', '2021-03-18 06:12:35', '2021-03-18 06:18:57', 'ingrediente.png', 1, '1 COMBO'),
(201, NULL, 'CON CERVEZA', 'gr', '2021-03-18 06:12:47', '2021-03-18 06:19:17', 'ingrediente.png', 1, '2 COMBO'),
(202, NULL, 'CON MR.TEA', 'gr', '2021-03-18 06:12:59', '2021-03-18 06:19:47', 'ingrediente.png', 1, '2 COMBO'),
(203, NULL, 'PORTOBELLO', 'gr', '2021-03-18 07:21:33', '2021-03-18 07:21:33', 'ingrediente.png', 1, NULL),
...
(209, NULL, 'CARNE FILETE', 'und', '2021-04-18 20:06:36', '2025-01-24 12:44:29', 'ingrediente.png', 1, ''),
(210, NULL, 'CEBOLLA CARAMELIZADA', 'gr', '2021-04-19 17:11:03', '2021-04-19 17:51:10', '1618872664.jpg', 1, ''),
(211, NULL, 'Fondue de queso con champiñones', 'gr', '2021-04-19 17:17:49', '2021-04-19 17:17:49', 'ingrediente.png', 1, NULL),
(212, NULL, 'TRIPLE QUESO', 'gr', '2021-04-19 17:30:36', '2021-04-19 17:30:36', 'ingrediente.png', 1, NULL),
(213, NULL, 'DOBLE FILETE DE POLLO', 'gr', '2021-04-19 17:35:12', '2021-04-19 17:35:12', 'ingrediente.png', 1, NULL),
(214, NULL, 'FILETE DE POLLO', 'gr', '2021-04-19 17:38:15', '2021-04-19 17:38:15', 'ingrediente.png', 1, NULL),
(215, NULL, 'DOBLE CROQUETA DE CARNE', 'gr', '2021-04-19 17:43:34', '2021-04-19 18:44:01', '1618875841.jpg', 1, ''),
(216, NULL, 'POLLO DESMECHADO BAÑADO EN LA SALSA DE LA CASA', 'gr', '2021-04-19 17:47:15', '2021-04-19 17:47:15', 'ingrediente.png', 1, NULL),
(217, NULL, 'CARNE DE HAMBURGUESA', 'gr', '2021-04-19 18:09:22', '2021-04-19 18:09:22', 'ingrediente.png', 1, NULL),
...
(220, NULL, 'POLLO DESMECHADO EN SALSA', 'gr', '2021-04-19 18:19:21', '2021-04-19 18:19:21', 'ingrediente.png', 1, NULL),
(221, NULL, 'FONDUE DE QUESO CHEDDAR', 'gr', '2021-04-19 18:20:47', '2021-04-19 18:43:05', '1618875783.jpg', 1, ''),
(222, NULL, 'DOBLE CARNE EN VARA', 'gr', '2021-04-19 18:22:16', '2021-04-19 18:22:16', 'ingrediente.png', 1, NULL),
(223, NULL, 'QUESO FUNDIDO CON CHAMPIÑONES', 'gr', '2021-04-19 18:59:54', '2021-04-19 18:59:54', 'ingrediente.png', 1, NULL),
(224, NULL, 'POLLO TROZOS', 'gr', '2021-04-19 19:00:57', '2025-01-24 17:12:58', 'ingrediente.png', 1, ''),
(225, NULL, 'PAPAS FRITAS', 'gr', '2021-04-19 19:13:27', '2021-04-19 19:13:27', 'ingrediente.png', 1, NULL),
(226, NULL, 'CEBOLLA CARAMELIZADA', 'gr', '2021-04-21 16:38:48', '2021-04-21 16:38:48', 'ingrediente.png', 1, NULL),
(227, NULL, 'DOBLE QUESO CREMA', 'gr', '2021-04-21 17:21:47', '2021-04-21 17:21:47', 'ingrediente.png', 1, NULL),
(228, NULL, 'SALCHICHA', 'gr', '2021-04-21 17:53:18', '2021-04-21 17:53:18', 'ingrediente.png', 1, NULL),
(229, NULL, 'HIELO', 'gr', '2022-05-01 17:04:36', '2022-05-01 17:04:36', 'ingrediente.png', 1, NULL),
(230, NULL, 'NARANJA', 'ml', '2022-05-01 17:05:15', '2022-05-01 17:05:15', 'ingrediente.png', 1, NULL),
(231, NULL, 'AZUCAR', 'gr', '2022-05-01 17:05:29', '2022-05-01 17:05:29', 'ingrediente.png', 1, NULL),
(232, NULL, 'JARRA', 'und', '2022-05-01 17:07:35', '2022-05-01 17:07:35', 'ingrediente.png', 1, NULL),
(233, NULL, 'MASA PIZZA', 'gr', '2022-09-30 09:21:47', '2022-09-30 09:21:47', 'ingrediente.png', 1, NULL),
(234, NULL, 'RAPI YUCA', 'und', '2025-01-22 20:53:39', '2025-01-22 20:53:39', 'ingrediente.png', 1, NULL),
(235, NULL, 'YUCA', 'und', '2025-01-24 12:41:15', '2025-01-24 17:09:52', 'ingrediente.png', 1, 'COSEPAN'),
(236, NULL, 'PICHAQUE', 'und', '2025-01-24 12:41:59', '2025-01-24 17:08:52', 'ingrediente.png', 1, 'VEGETALES'),
(237, NULL, 'CHULETA AHUMADA', 'und', '2025-01-24 12:47:20', '2025-01-24 12:47:20', 'ingrediente.png', 1, NULL),
(238, NULL, 'CARNE CHURRASCO', 'und', '2025-01-24 12:49:06', '2025-01-24 12:49:06', 'ingrediente.png', 1, NULL),
(239, NULL, 'CARNE CHURRASQUITO', 'und', '2025-01-24 12:49:20', '2025-01-24 12:49:20', 'ingrediente.png', 1, NULL),
(240, NULL, 'CHINCHULLA', 'und', '2025-01-24 12:51:31', '2025-01-24 12:51:31', 'ingrediente.png', 1, NULL),
(241, NULL, 'SOPA SANCOCHO', 'und', '2025-01-24 12:53:35', '2025-01-24 12:53:35', 'ingrediente.png', 1, NULL),
(242, NULL, 'CACHAMA', 'und', '2025-01-24 12:59:12', '2025-01-24 12:59:12', 'ingrediente.png', 1, NULL),
(243, NULL, 'MORCILLA', 'und', '2025-01-24 13:28:42', '2025-01-24 13:28:42', 'ingrediente.png', 1, NULL),
(244, NULL, 'VEGETALES', 'gr', '2025-01-24 21:56:05', '2025-02-01 11:38:07', 'ingrediente.jpg', 1, 'VEGETALES'),
(245, NULL, 'AREPA ASADA', 'und', '2025-01-24 22:01:12', '2025-01-24 22:01:12', 'ingrediente.png', 1, NULL),
(246, NULL, 'TODO', 'und', '2025-01-27 19:57:52', '2025-01-27 19:57:52', 'ingrediente.png', 1, NULL),
(247, NULL, 'SIN VEGETALES', 'und', '2025-01-27 20:03:26', '2025-01-27 20:03:26', 'ingrediente.png', 1, NULL),
(248, NULL, 'VEGETALES NO', 'und', '2025-01-27 20:10:14', '2025-01-27 20:10:14', 'ingrediente.png', 1, NULL),
(249, NULL, 'MITAD', 'und', '2025-01-27 20:56:51', '2025-01-27 20:56:51', 'ingrediente.png', 1, NULL),
(250, NULL, 'CILANTRO', 'und', '2025-01-27 21:18:19', '2025-01-27 21:18:19', 'ingrediente.png', 1, NULL),
(251, NULL, 'AL VAPOR', 'und', '2025-02-02 10:28:01', '2025-02-02 10:28:01', 'ingrediente.png', 1, NULL),
(252, NULL, 'caldo', 'und', '2025-03-02 22:59:26', '2025-03-02 22:59:26', 'ingrediente.png', 1, NULL),
(253, NULL, 'bagre tajada', 'und', '2025-03-02 23:00:35', '2025-03-02 23:00:35', 'ingrediente.png', 1, NULL);
...
--
-- Estructura de tabla para la tabla `pizza_producto`
--
...
--
-- Volcado de datos para la tabla `pizza_producto`
--

INSERT INTO `pizza_producto` (`id`, `codigo`, `descripcion`, `detalle`, `tipo_producto_id`, `observacion`, `valor`, `impcomanda`, `created_at`, `updated_at`, `imagen`, `estado`, `iva`, `grupo`, `bodega`, `unidad`, `marca`, `terminado`, `compuesto`, `impco`) VALUES
...
(11, NULL, 'SANCOCHO  2P', 'SANCOCHO', 3, NULL, '0.00', '1', '2025-01-24 12:55:09', '2025-02-02 10:23:35', '', 1, '0.00', '', NULL, NULL, NULL, 0, 9, '0.00'),
...
(13, NULL, 'MOJARRA FRITA', '600 GR MOJARRA', 3, NULL, '0.00', '1', '2025-01-24 13:01:01', '2025-02-02 10:24:00', '', 1, '0.00', '', NULL, NULL, NULL, 0, 9, '0.00'),
...
(15, NULL, 'MILLER LITE 300ML', 'MILLER LITE 300ML', 2, NULL, '0.00', '1', '2025-01-24 13:01:58', '2025-01-27 21:52:20', '', 3, '0.00', '', NULL, NULL, NULL, 1, 0, '0.00'),
...
(19, NULL, 'CERVEZA SOL', 'CERVEZA SOL', 2, NULL, '0.00', '1', '2025-01-24 13:05:46', '2025-01-27 21:52:25', '', 3, '0.00', '', NULL, NULL, NULL, 1, 0, '0.00'),
...
(36, NULL, 'CHORIPAPA 1P', 'CHORIIPAPA 1P', 7, NULL, '0.00', '1', '2025-01-24 17:20:24', '2025-01-27 20:44:33', '', 1, '0.00', 'SALCHIPAPAS', NULL, NULL, NULL, 0, 0, '0.00'),
(37, NULL, 'SALCHICARNE 2P', 'SALCHICARNE A2 P', 7, NULL, '0.00', '1', '2025-01-24 17:21:40', '2025-01-27 20:48:43', '', 1, '0.00', 'SALCHIPAPAS', NULL, NULL, NULL, 0, 0, '0.00'),
...
(44, NULL, 'Arep. Carne y aguacate', 'Carne con aguacate', 12, NULL, '0.00', '1', '2025-01-27 17:35:31', '2025-01-27 18:31:53', '', 1, '0.00', 'AREPAS', NULL, NULL, NULL, 0, 0, '0.00'),
(45, NULL, 'Arep.pollo y queso', 'pollo, queso', 12, NULL, '0.00', '1', '2025-01-27 18:00:21', '2025-01-27 18:41:56', '', 1, '0.00', 'AREPAS', NULL, NULL, NULL, 0, 0, '0.00'),
(46, NULL, 'Arep.Carne desm', 'carne desmechada', 12, NULL, '0.00', '1', '2025-01-27 18:03:36', '2025-01-27 18:42:27', '', 1, '0.00', 'Arepas', NULL, NULL, NULL, 0, 0, '0.00'),
(47, NULL, 'Arepa Pollo', 'pollo', 12, NULL, '0.00', '1', '2025-01-27 18:06:36', '2025-01-27 18:22:10', '', 1, '0.00', 'Arepas', NULL, NULL, NULL, 0, 0, '0.00'),
(48, NULL, 'Arepa de queso', 'queso', 12, NULL, '0.00', '1', '2025-01-27 18:10:02', '2025-01-27 18:10:02', '', 1, '0.00', 'Arepas', NULL, NULL, NULL, 0, 0, '0.00'),
(49, NULL, 'Arep', 'pollo, queso', 12, NULL, '0.00', '1', '2025-01-27 18:24:28', '2025-01-27 18:48:59', '', 3, '0.00', 'Arepas', NULL, NULL, NULL, 0, 0, '0.00'),
(50, NULL, 'Arep.carne y queso', 'Carne, queso', 12, NULL, '0.00', '1', '2025-01-27 18:25:55', '2025-01-27 18:41:02', '', 1, '0.00', 'Arepas', NULL, NULL, NULL, 0, 0, '0.00'),
(51, NULL, 'Arep.Porc aguacate', 'Aguacate', 12, NULL, '0.00', '1', '2025-01-27 18:28:55', '2025-01-27 18:46:34', '', 1, '0.00', 'AREPAS', NULL, NULL, NULL, 0, 0, '0.00'),
...
(69, NULL, 'SALCHI 1P SIN VEG', 'SIN CEB\n', 7, NULL, '0.00', '1', '2025-01-27 20:25:52', '2025-01-27 20:32:52', '', 3, '0.00', '', NULL, NULL, NULL, 0, 0, '0.00'),
...
(90, NULL, 'Combo hamburguesa', 'Combo hamburguesa', 13, NULL, '0.00', '1', '2025-01-29 19:09:40', '2025-01-29 19:15:07', '', 3, '0.00', '', NULL, NULL, NULL, 0, 9, '0.00'),
...
(96, NULL, 'ADIC.QUESO', 'ADIC. QUESO', 12, NULL, '0.00', '1', '2025-01-29 22:36:55', '2025-01-29 22:36:55', '', 1, '0.00', 'AREPAS', NULL, NULL, NULL, 0, 0, '0.00'),
...
(100, NULL, 'ADIC. SALCHIICHA', 'SALCHIICHA', 12, NULL, '0.00', '1', '2025-01-29 22:45:23', '2025-01-29 22:45:23', '', 1, '0.00', 'AREPAS', NULL, NULL, NULL, 0, 0, '0.00'),
(101, NULL, 'arepa nueva', 'arepa nueva', 12, NULL, '0.00', '1', '2025-03-02 22:33:05', '2025-03-02 22:33:05', '', 1, '0.00', '', NULL, NULL, NULL, 0, 0, '0.00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pizza_producto_ingrediente`
--

CREATE TABLE `pizza_producto_ingrediente` (
  `id` int(10) NOT NULL,
  `producto_id` int(10) NOT NULL,
  `ingrediente_id` int(10) NOT NULL,
  `created_at` datetime DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `pizza_producto_ingrediente`
--

INSERT INTO `pizza_producto_ingrediente` (`id`, `producto_id`, `ingrediente_id`, `created_at`, `updated_at`, `tamano`, `cantidad`, `visible`) VALUES
...
--
-- Estructura de tabla para la tabla `pizza_producto_pedido`
--

CREATE TABLE `pizza_producto_pedido` (
  `id` int(10) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pizza_producto_pedido_adicional`
--

CREATE TABLE `pizza_producto_pedido_adicional` (
  `id` int(10) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pizza_producto_pedido_documento`
--

CREATE TABLE `pizza_producto_pedido_documento` (
  `id` int(10) NOT NULL,
  `producto_id` int(10) NOT NULL,
  `cant` int(5) NOT NULL,
  `valor` decimal(14,2) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pizza_producto_pedido_ingrediente`
--

CREATE TABLE `pizza_producto_pedido_ingrediente` (
  `id` int(10) NOT NULL,
  `producto_pedido_id` int(10) NOT NULL,
  `ingrediente_id` int(10) NOT NULL,
  `cant` int(5) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `pizza_producto_sabor`
--

CREATE TABLE `pizza_producto_sabor` (
  `id` int(11) NOT NULL,
  `updated_at` datetime DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `pizza_producto_tamano`
--

CREATE TABLE `pizza_producto_tamano` (
  `id` int(11) NOT NULL,
  `updated_at` datetime DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `tamano` varchar(10) NOT NULL,
...
--
-- Volcado de datos para la tabla `pizza_producto_tamano`
--

INSERT INTO `pizza_producto_tamano` (`id`, `updated_at`, `created_at`, `tamano`, `producto_id`, `valor`) VALUES
...
--
-- Estructura de tabla para la tabla `pizza_puntos`
--

CREATE TABLE `pizza_puntos` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pizza_sabor`
--
...
--
-- Volcado de datos para la tabla `pizza_sabor`
--

INSERT INTO `pizza_sabor` (`id`, `updated_at`, `created_at`, `descripcion`) VALUES
...
--
-- Estructura de tabla para la tabla `pizza_saldos_producto`
--

CREATE TABLE `pizza_saldos_producto` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pizza_tabla`
--

CREATE TABLE `pizza_tabla` (
  `id` int(11) NOT NULL,
  `codigo` varchar(10) NOT NULL,
  `descripcion` varchar(100) NOT NULL,
...
--
-- Volcado de datos para la tabla `pizza_tabla`
--

INSERT INTO `pizza_tabla` (`id`, `codigo`, `descripcion`, `tabla`, `valor`, `valor_alf`, `updated_at`, `created_at`) VALUES
...
--
-- Estructura de tabla para la tabla `pizza_tercero`
--

CREATE TABLE `pizza_tercero` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pizza_tipo_documento`
--

CREATE TABLE `pizza_tipo_documento` (
  `id` int(10) NOT NULL,
...
--
-- Volcado de datos para la tabla `pizza_tipo_documento`
--

INSERT INTO `pizza_tipo_documento` (`id`, `codigo`, `descripcion`, `imparqueo`, `created_at`, `updated_at`, `consecutivo`, `tipoIE`) VALUES
...
--
-- Estructura de tabla para la tabla `pizza_tipo_producto`
--

CREATE TABLE `pizza_tipo_producto` (
  `id` int(10) NOT NULL,
...
--
-- Volcado de datos para la tabla `pizza_tipo_producto`
--

INSERT INTO `pizza_tipo_producto` (`id`, `codigo`, `descripcion`, `created_at`, `updated_at`, `fracciones`, `aplica_tamanos`, `aplica_sabores`, `aplica_ingredientes`, `estado`, `impresora`, `tamanos`, `valor_editable`, `orden`, `cobro_fraccion`) VALUES
...
--
-- Estructura de tabla para la tabla `pizza_users`
--
...
--
-- Volcado de datos para la tabla `pizza_users`
--

INSERT INTO `pizza_users` (`id`, `updated_at`, `created_at`, `usuario`, `password`, `nombres`, `apellidos`, `rol`, `remember_token`, `conn`, `api_token`, `impresora`, `caja_id`) VALUES
...
--
-- Indices de la tabla `pizza_adicional`
--
...
--
-- Indices de la tabla `pizza_combo`
--
ALTER TABLE `pizza_combo`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pizza_combo_producto`
--
ALTER TABLE `pizza_combo_producto`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pizza_config`
--
ALTER TABLE `pizza_config`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pizza_detalle_documento`
--
ALTER TABLE `pizza_detalle_documento`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pizza_documento`
--
ALTER TABLE `pizza_documento`
  ADD PRIMARY KEY (`id`),
  ADD KEY `documento_usuario_fk_idx` (`usuario_id`);

--
-- Indices de la tabla `pizza_documento_formapago`
--
ALTER TABLE `pizza_documento_formapago`
  ADD PRIMARY KEY (`id`),
  ADD KEY `rel_doc_fp` (`formapago_id`);

--
-- Indices de la tabla `pizza_formapago`
--
ALTER TABLE `pizza_formapago`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pizza_producto`
--
ALTER TABLE `pizza_producto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `producto_tipo_fk_idx` (`tipo_producto_id`);

--
-- Indices de la tabla `pizza_producto_ingrediente`
--
ALTER TABLE `pizza_producto_ingrediente`
  ADD PRIMARY KEY (`id`),
  ADD KEY `producto_ingrediente_ingrediente_fk_idx` (`ingrediente_id`),
  ADD KEY `producto_ingrediente_producto_fk_idx` (`producto_id`);

--
-- Indices de la tabla `pizza_producto_pedido`
--
ALTER TABLE `pizza_producto_pedido`
  ADD PRIMARY KEY (`id`),
  ADD KEY `producto_pedido_producto_idx` (`producto_id`),
  ADD KEY `producto_pedido_pedido_fk_idx` (`pedido_id`);

--
-- Indices de la tabla `pizza_producto_pedido_adicional`
--
ALTER TABLE `pizza_producto_pedido_adicional`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pizza_producto_pedido_documento`
--
ALTER TABLE `pizza_producto_pedido_documento`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pizza_producto_pedido_ingrediente`
--
ALTER TABLE `pizza_producto_pedido_ingrediente`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pizza_producto_sabor`
--
ALTER TABLE `pizza_producto_sabor`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pizza_producto_tamano`
--
ALTER TABLE `pizza_producto_tamano`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id` (`id`),
  ADD KEY `producto_tamano_fk_idx` (`producto_id`);

--
-- Indices de la tabla `pizza_puntos`
--
ALTER TABLE `pizza_puntos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pizza_sabor`
--
...
--
-- Indices de la tabla `pizza_saldos_producto`
--
ALTER TABLE `pizza_saldos_producto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `saldos_producto_fk` (`producto_id`);

--
-- Indices de la tabla `pizza_tabla`
--
ALTER TABLE `pizza_tabla`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pizza_tercero`
--
ALTER TABLE `pizza_tercero`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_ter_identi` (`identificacion`),
  ADD KEY `idx_ter_nombre` (`nombrecompleto`);

--
-- Indices de la tabla `pizza_tipo_documento`
--
ALTER TABLE `pizza_tipo_documento`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pizza_tipo_producto`
--
ALTER TABLE `pizza_tipo_producto`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pizza_users`
--
ALTER TABLE `pizza_users`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `id` (`id`);
...
--
-- AUTO_INCREMENT de la tabla `pizza_adicional`
--
ALTER TABLE `pizza_adicional`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pizza_combo`
--
ALTER TABLE `pizza_combo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pizza_combo_producto`
--
ALTER TABLE `pizza_combo_producto`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pizza_config`
--
ALTER TABLE `pizza_config`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `pizza_detalle_documento`
--
ALTER TABLE `pizza_detalle_documento`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT de la tabla `pizza_documento`
--
ALTER TABLE `pizza_documento`
...
--
-- AUTO_INCREMENT de la tabla `pizza_producto`
--
ALTER TABLE `pizza_producto`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT de la tabla `pizza_producto_ingrediente`
--
ALTER TABLE `pizza_producto_ingrediente`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2275;

--
-- AUTO_INCREMENT de la tabla `pizza_producto_pedido`
--
ALTER TABLE `pizza_producto_pedido`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT de la tabla `pizza_producto_pedido_adicional`
--
ALTER TABLE `pizza_producto_pedido_adicional`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pizza_producto_pedido_documento`
--
ALTER TABLE `pizza_producto_pedido_documento`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pizza_producto_pedido_ingrediente`
--
ALTER TABLE `pizza_producto_pedido_ingrediente`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=155;

--
-- AUTO_INCREMENT de la tabla `pizza_producto_sabor`
--
ALTER TABLE `pizza_producto_sabor`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pizza_producto_tamano`
--
ALTER TABLE `pizza_producto_tamano`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT de la tabla `pizza_puntos`
--
ALTER TABLE `pizza_puntos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pizza_sabor`
--
ALTER TABLE `pizza_sabor`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT de la tabla `pizza_saldos_producto`
--
ALTER TABLE `pizza_saldos_producto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT de la tabla `pizza_tabla`
--
ALTER TABLE `pizza_tabla`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `pizza_tercero`
--
ALTER TABLE `pizza_tercero`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `pizza_tipo_documento`
--
ALTER TABLE `pizza_tipo_documento`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `pizza_tipo_producto`
--
ALTER TABLE `pizza_tipo_producto`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `pizza_users`
--
ALTER TABLE `pizza_users`
...
--
-- Filtros para la tabla `pizza_adicional`
--
ALTER TABLE `pizza_adicional`
  ADD CONSTRAINT `adicional_ingrediente_fk` FOREIGN KEY (`ingrediente_id`) REFERENCES `pizza_ingrediente` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `adicional_product_fk` FOREIGN KEY (`producto_id`) REFERENCES `pizza_producto` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `adicional_tipo_producto_fk` FOREIGN KEY (`tipo_producto_id`) REFERENCES `pizza_tipo_producto` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `pizza_pedido`
--
ALTER TABLE `pizza_pedido`
  ADD CONSTRAINT `pedido_user_fk` FOREIGN KEY (`user_id`) REFERENCES `pizza_users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `pizza_producto`
--
ALTER TABLE `pizza_producto`
  ADD CONSTRAINT `producto_tipo_fk` FOREIGN KEY (`tipo_producto_id`) REFERENCES `pizza_tipo_producto` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `pizza_producto_ingrediente`
--
ALTER TABLE `pizza_producto_ingrediente`
  ADD CONSTRAINT `producto_ingrediente_ingrediente_fk` FOREIGN KEY (`ingrediente_id`) REFERENCES `pizza_ingrediente` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `producto_ingrediente_producto_fk` FOREIGN KEY (`producto_id`) REFERENCES `pizza_producto` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `pizza_producto_pedido`
--
ALTER TABLE `pizza_producto_pedido`
  ADD CONSTRAINT `producto_pedido_pedido_fk` FOREIGN KEY (`pedido_id`) REFERENCES `pizza_pedido` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `producto_pedido_producto` FOREIGN KEY (`producto_id`) REFERENCES `pizza_producto` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `pizza_producto_pedido_adicional`
--
ALTER TABLE `pizza_producto_pedido_adicional`
  ADD CONSTRAINT `producto_pedido_adicional_adicional` FOREIGN KEY (`adicional_id`) REFERENCES `pizza_adicional` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `producto_pedido_adicional_producto_pedido` FOREIGN KEY (`producto_pedido_id`) REFERENCES `pizza_producto_pedido` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `pizza_producto_pedido_ingrediente`
--
ALTER TABLE `pizza_producto_pedido_ingrediente`
  ADD CONSTRAINT `producto_pedido_ingrediente_ingrediente` FOREIGN KEY (`ingrediente_id`) REFERENCES `pizza_ingrediente` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `producto_pedido_ingrediente_producto_pedido` FOREIGN KEY (`producto_pedido_id`) REFERENCES `pizza_producto_pedido` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `pizza_producto_sabor`
--
ALTER TABLE `pizza_producto_sabor`
  ADD CONSTRAINT `producto_sabor_producto_id` FOREIGN KEY (`producto_id`) REFERENCES `pizza_producto` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `producto_sabor_sabor` FOREIGN KEY (`sabor_id`) REFERENCES `pizza_sabor` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `pizza_producto_tamano`
--
ALTER TABLE `pizza_producto_tamano`
  ADD CONSTRAINT `producto_tamano_fk` FOREIGN KEY (`producto_id`) REFERENCES `pizza_producto` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
