...
<section class="borde-inferior form fondo-comun"  style="min-height: 80vh;">
    <div class="container">
        ...
        <form  data-toggle = "validator" method="POST" action="crear" accept-charset="UTF-8" class="form" novalidate="novalidate" enctype="multipart/form-data">
        {{ csrf_field() }}
        <h1 class = "titulo">CREANDO Ingrediente</h1>
            ...
            <div class = "col-md-6" style="height: 91px">
                <div class = "form-group">
                    <label class="radio-inline control-label" style="font-weight: bold; padding-left: 0px;">
                        Visible <input checked id="visible" type="checkbox" value="1" name="visible" style="width: 20px; margin-left: 10px;">
                    </label>
