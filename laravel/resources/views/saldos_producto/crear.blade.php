...
@section('titulo', 'Nueva Inventario')
@section('lib')
...
<div class='container'>
    ...
    <div class="row" style="background-color: white; padding: 10px">
        <div class="col-md-12"><h2>Creando Inventario </h2></div><br/><br/>
        <div class="col-md-12">
            <form id="crear-saldos_producto" data-toggle = "validator" role = "form" action = '{{url("/saldos_producto")}}' method="POST">
                <br/>
                {{ csrf_field() }}
                <div class = "row">
                    ...
                    <div class = "col-md-6">
                        <div class = "campo tipo select form-group has-feedback {{ ($errors->first('producto_id')) ? 'has-error' :'' }}">
                            ...
                            @if(old('producto_id'))
                                <script>$("select#producto_id").val("{{ old('producto_id') }}");</script>
                            @endif
                        </div>
                    </div>
                    <div class = "col-md-6">
                    ...
                    <div class = "col-md-6">
                        <div class = "campo tipo texto form-group has-feedback {{ ($errors->first('existencia')) ? 'has-error' :'' }}">
                            ...
                            <input type = "text" class = "form-control" id = "existencia" name = "existencia" value = "{{ old('existencia') }}" required/>
                            <span class = "glyphicon form-control-feedback" aria-hidden = "true"></span>
                    ...
                    <div class = "col-md-6">
                        <div class = "campo tipo texto form-group has-feedback {{ ($errors->first('existencia_max')) ? 'has-error' :'' }}">
                            ...
                            <input type = "text" class = "form-control" id = "existencia_max" name = "existencia_max" value = "{{ old('existencia_max') }}" required/>
                            <span class = "glyphicon form-control-feedback" aria-hidden = "true"></span>
                    ...
                    <div class = "col-md-6">
                        <div class = "campo tipo texto form-group has-feedback {{ ($errors->first('existencia_min')) ? 'has-error' :'' }}">
                            ...
                            <input type = "text" class = "form-control" id = "existencia_min" name = "existencia_min" value = "{{ old('existencia_min') }}" required/>
                            <span class = "glyphicon form-control-feedback" aria-hidden = "true"></span>
                ...
                <div class = "col-md-12">
                    <div class = "form-group centrado">
                        <h1 class="titulo">
                            <button type = "submit" class = "btn btn-sm btn-success"><span class="fa fa-save" aria-hidden="true"></span> Crear</button>
